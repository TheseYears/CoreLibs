...
public class BaseAdapterHelper extends RecyclerView.ViewHolder {
    ...
    /**
     * Will put image from a File into an ImageView.<br/>
     * It uses Square's Glide library.
     * @param viewId   The view id.
     * @param image The image File.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setImageFile(int viewId, File image) {
        ImageView view = retrieveView(viewId);
    ...
    /**
     * Sets the select status of the view.
     * @param viewId   The view id.
     * @param selected The select status.
     * @return The BaseAdapterHelper for chaining.
     */
    ...
    /**
     * Sets the enable status of a view.
     * @param viewId  The view id.
     * @param enable The enable status;
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setEnable(int viewId, boolean enable) {
        View view = retrieveView(viewId);
